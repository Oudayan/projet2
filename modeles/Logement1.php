...
*/
	class Logement
	{
		...
		public function __construct($id = 0, $nb_i = "", $nb_civique = "", $r= "", $cp = "", $prov = "", $ville ="", 
	                                $nbp = 0, $nbc = 0, $nbl = 0, $nbs = 0, $nbds = 0, $lat="", $long="", $d="", 
	                                $is_p = 0, $is_w = 0, $is_c = 0, $is_t = 0, $is_f = 0, $is_ci = 0, $is_se = 0, $is_ch =0,
	                                $photo = 0, $na = 0, $ban=0, $bandat= "", $bancomm = "", $curriel = "", $tlog = 0)
		{
				this->id_logement = $id;
				this->nb_interieur =;
				this->nb_civique =;
