 ...
 * @version  1.0
 * @date     06 mars 2018
 * @brief    Vue partielle pour afficher un Logement dans le module admin
 * 
 */
?>
    <div style="height:500px" id="ficheLogement">
        ...
        <button type="button" class="btn btn-secondary" onclick="bannirLogement()">Bannir</button>
        <hr>
        ...
        <div class="table-responsive">
            <!-- form-group row heigthFormBLecture -->
            <table class="table">
