    ...
    <header>
        <nav class="navbar navbar-toggleable-sm bg-inverse navbar-inverse mb-5 text-white">
            <div class="container px-5 px-sm-0">
                <a href="index.php?Recherche&action=accueil" class="navbar-brand mr-5"><img src="images/logo.png" alt="logo" style="width:100px;"></a>
                                ...
                                <div class="modal-body" style="padding:15px 15px;">
                                    <form role="form" action="index.php?Usagers&action=verificationLogin" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="courriel"><span class="fa fa-envelope" aria-hidden="true"></span></label>
